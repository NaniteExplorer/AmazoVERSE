    ...
    <Fragment>
      {loading ? (
        ...
        <Fragment>
          <MetaData
            title={products.name}
            description={`Buy ${products.name} on Amaezoverse and compare its price across Amazon, Flipkart and more. ${
              products.description ? products.description.slice(0, 120) : ""
            }`}
            image={
          ...
          <div className="ProductDetails">
            ...
            <div>
              ...
              <PriceComparison
                basePrice={products && products.price}
